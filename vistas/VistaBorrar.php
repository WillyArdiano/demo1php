...
<html>
    ...
    <body>
        <div id="divCentro">
            <h1>Seleccione el sistema a eliminar:</h1>
                <?php
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {?>
                            <a style="font: 150% sans-serif;" href="../controladores/ControladorBorrar.php?sisn=<?php echo($row['nombre']); ?>" > <?php echo($row['nombre']); ?> </a>
                            <br>
                        <?php
                        }
                    }
